...
echo "  ${PROTO_DIR}/stt_worker_pb2.pyi"

# --- TTS ---
echo ""
echo "Generating gRPC stubs from ${PROTO_DIR}/tts_worker.proto ..."
...
# Fix import path: grpc_tools generates 'import tts_worker_pb2'
# but we need 'from theo.proto import tts_worker_pb2' for package imports.
sed -i 's/^import tts_worker_pb2/from theo.proto import tts_worker_pb2/' \
  "${PROTO_DIR}/tts_worker_pb2_grpc.py"

echo "Generated:"
echo "  ${PROTO_DIR}/tts_worker_pb2.py"
echo "  ${PROTO_DIR}/tts_worker_pb2_grpc.py"
echo "  ${PROTO_DIR}/tts_worker_pb2.pyi"
